...
*Setter du binwitdth til vedien 0.1, vil alle unike verdier i datasettet bli telt hver for seg. Dette er fordi det ikke er noen biler i datasettet som har en MPG-verdi som er 0.1 unna en høyere eller lavere verdi.*

Eksperimenter med forskjellige verdier for `binwidth` og forklar hva som kjennetegner en god verdi.

*En god verdi for binwidth er en verdi som gjør figruen tydelig og oversiktlig, slik at man kan enkelt se hvor majoriteten av MPG-verdiene ligger. Samtidig ønsker vi ikke å vise for mange verdier, selv om dette er mer detaljert, gjør dette figuren vanskeligere å tolke. Derfor kan det i dette tilfellet være best å bruke er verdi mellom 1 og 1,5.*
...
df %>% 
  ...
  facet_grid(factor(sysselsettingsgruppe)~næring) +
  theme(legend.position="bottom") +
  xlab("Verdi") +
  ylab("Antall")
